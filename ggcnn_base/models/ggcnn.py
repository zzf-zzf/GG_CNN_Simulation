...
class GGCNN(nn.Module):
    ...
    def __init__(self, input_channels=1):
        ...
        for m in self.modules():
            if isinstance(m, (nn.Conv2d, nn.ConvTranspose2d)):
                nn.init.xavier_uniform_(m.weight, gain=1) #initialization，uniform distribution，variance not change
    ...
    def compute_loss(self, xc, yc):
        ...
        p_loss = F.mse_loss(pos_pred, y_pos) #L2 loss function (mean square error)
